...
class UpdateMyDetails:
    def __init__(self, myResults):
        ...
        def toVerify():
            ...
            if len(Add) > 300:
                ...
                try:
                    ...
                    val = (myResults[0], Name, Pass,
                           myGender, Add, Dob, Mobile)
        ...
        userNameLabel = Label(
            passFrame, text="USER NAME : ", font=("Product Sans", 14))
        ...
        userPassLabel = Label(passFrame, text="PASSWORD : ",
        ...
        userGender = Label(passFrame, text="GENDER : ",
                           font=("Product Sans", 14))
        userGender.place(x=50, y=150)
        userGender.config(bg="white", fg="midnightblue")
        x = IntVar()
        # PY_VAR0
        GenderM = Radiobutton(passFrame, text="Male", variable=x, value=1, font=("Product Sans", 14),
                              fg="midnightblue",
                              bg="white")
        GenderM.place(x=153, y=150)
        GenderF = Radiobutton(passFrame, text="Female", variable=x, value=2, font=("Product Sans", 14),
                              fg="midnightblue",
                              bg="white")
        ...
        userPhnoLabel = Label(
            passFrame, text="PHONE NO. : ", font=("Product Sans", 14))
        ...
        userAddressLabel = Label(
            passFrame, text="ADDRESS : ", font=("Product Sans", 14))
        ...
        userDobLabel = Label(
            passFrame, text="Date Of Birth : ", font=("Product Sans", 14))
        ...
        updateMyDetails = Button(
            passFrame, text="UPDATE", font=("Product Sans", 14))
        ...
        updateMyDetails.config(bg="midnightblue", fg="white", activebackground="midnightblue",
                               ...
                               borderwidth=0)
        button = Button(passFrame, text="ç", font=(
        ...
        button.config(bg="midnightblue", fg="white",
                      activeforeground="white", activebackground="midnightblue")

        mywall = ImageTk.PhotoImage(Image.open("images/updateDetails.jpg"))
...
if __name__ == '__main__':
    newPage = UpdateMyDetails(
        (909, "Anshuman", "Anshu@123", "Male", "Mumbai", "09-02-2003", "9892609458"))
