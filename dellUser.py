            ...
            try:
                ...
                try:
                    database.myQuery.execute(
                        f"select * from myUser where user_id={toMakeInt}")
                    myResult = database.myQuery.fetchone()
                    print(myResult)
                    if myResult is not None:
                        database.myQuery.execute(
                            f"delete from myUser where user_id={toMakeInt}")
