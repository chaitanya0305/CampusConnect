...
class MyDetails:
    def __init__(self, myResults):
        ...
        showID.config(bg="white", fg="#4D50F1")
        ...
        showName.config(bg="white", fg="#4D50F1")
        ...
        showPass.config(bg="white", fg="#4D50F1")
        ...
        showGen.config(bg="white", fg="#4D50F1")
        ...
        showPhno.config(bg="white", fg="#4D50F1")
