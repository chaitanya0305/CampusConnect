...
myDatabase = sqlite3.connect('cc.db')
...
# try:
                    ...
                    if dataBase.myQuery:
                            print("finallyyyyyyy")
                    # except:
                        # popup.showwarning("CampusConnect", "Kindly Enter Valid ID And Password")
                # except:
                #     popup.showwarning("CampusConnect", "Kindly Enter Valid ID")
'''
